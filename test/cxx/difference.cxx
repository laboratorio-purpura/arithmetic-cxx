...
TYPED_TEST(PurpleHegelTest,difference_N_1_accumulate)
{
    ...
    hegel::test([](hegel::TestCase& tc)
    {
        ...
        ignore = difference<word>(r1,x,y);

        // accumulate result

        auto r2 = vector<word>(z);
        assign<word>(r2,x);
        ignore = difference<word>(r2,r2,y);
...
TYPED_TEST(PurpleHegelTest,difference_N_1_differential)
{
    constexpr auto Bits = tuple_element<0,TypeParam>::type::value;
    using word = word<Bits>;
...
TYPED_TEST(PurpleRandomTest,difference_N_1_differential)
{
    constexpr auto Bits = tuple_element<0,TypeParam>::type::value;
...
TYPED_TEST(PurpleHegelTest,difference_accumulate)
{
    constexpr auto Bits = tuple_element<0,TypeParam>::type::value;
    using word = word<Bits>;
...
TYPED_TEST(PurpleHegelTest,difference_differential)
{
    constexpr auto Bits = tuple_element<0,TypeParam>::type::value;
    using word = word<Bits>;
...
TYPED_TEST(PurpleRandomTest,difference_differential)
{
    constexpr auto Bits = tuple_element<0,TypeParam>::type::value;
    using generator = tuple_element<1,TypeParam>::type;
    using word = word<Bits>;
