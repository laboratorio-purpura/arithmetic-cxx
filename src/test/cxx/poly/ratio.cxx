...
TEST(poly,ratio_normalised_accumulate_v00_80000000)
{
    auto x = v00;
    auto y = 0x80000000U;
    auto q = array<unsigned,2>();
    auto iy = inverse_normalised(y);
    auto r = ratio_normalised_accumulate<unsigned>( span(q), span(x), y, iy );
    ASSERT_EQ( format(q), "0000000000000000" );
    ASSERT_EQ( format(r), "00000000" );
}

TEST(poly,ratio_normalised_accumulate_vMM_80000000)
{
    auto x = vMM;
    auto y = 0x80000000U;
    auto q = array<unsigned,2>();
